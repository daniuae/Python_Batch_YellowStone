...
In HR systems, each employee can be represented as an object with attributes and behaviors.
...
* How to structure programs using the `main()` function.

These concepts form the foundation of Object-Oriented Programming (OOP) in Python.
